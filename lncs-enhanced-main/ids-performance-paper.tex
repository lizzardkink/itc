...
\item \textbf{Coefficient of Variation (CV)}: Normalized variability measure calculated as CV = $\sigma/\mu \times 100\%$. This dimensionless metric allows comparison of variability across metrics with different units. Values below 20\% indicate good measurement consistency, following benchmarking best practices~\cite{anandtech-statistical-methods,box2005}.
